...
{{-- <div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.language") }}">
                    @csrf
                    <div class="form-group">
                        <select name="lang" id="language" class="form-control">
                            <option value="en" @if (app()->getLocale() == 'en') selected @endif>English</option>
                            <option value="ar" @if (app()->getLocale() == 'ar') selected @endif>عربي</option>
                        </select>
                        <button style="margin-top: 35px" class="btn btn-success" type="submit">
                            {{ trans('global.save') }}
                        </button>
                    </div>
                </form>
